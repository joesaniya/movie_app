...
class _BookmarksScreenState extends State<BookmarksScreen>
  ...
  List<Bookmark> _filtered(List<Bookmark> bookmarks) {
    ...
    return bookmarks
        .where((b) => b.movieTitle.toLowerCase().contains(q))
        .toList();
  }
        ...
        children: [
          ...
          SafeArea(
            child: Consumer<BookmarkProvider>(
              builder: (_, bk, __) {
                if (bk.isLoading && bk.bookmarks.isEmpty)
                    ...
                    Expanded(
                      child: all.isEmpty
                          ? const lw.EmptyWidget(
                              ...
                              message:
                                  'Bookmark films from your collection to build your personal library.',
                            )
                          : filtered.isEmpty
                          ? Center(
                              child: Text(
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: AppTheme.warmGray.withOpacity(0.4),
                width: 0.5,
              ),
            ),
            child: Row(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Icon(
          icon,
          size: 16,
          color: active ? AppTheme.inkBlack : AppTheme.ashGray,
        ),
      ),
    );
  }
      ...
      itemBuilder: (_, i) {
        return TweenAnimationBuilder<double>(
          ...
          child: _GridCard(
            ...
            onRemove: () => _confirmRemove(context, bookmarks[i], bk),
          ),
        );
      },
    );
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: const BorderSide(color: AppTheme.warmGray, width: 0.5),
        ),
        title: const Text(
        ...
        content: Text(
          'Remove "${bookmark.movieTitle}" from your saved films?',
          style: const TextStyle(
            fontFamily: 'DMSans',
            fontSize: 13,
            color: AppTheme.ashGray,
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('"${bookmark.movieTitle}" removed'),
